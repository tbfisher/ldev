/*
 * Varnish 4 config for Drupal 7 & 8 / Pressflow 6 & 7
 */

# @see
# - https://digitalist.se/blogg/purge-cachetags-varnish
# - https://www.jeffgeerling.com/blog/2016/use-drupal-8-cache-tags-varnish-and-purge
# - https://github.com/geerlingguy/drupal-vm/issues/397
#
# starting points:
# - https://github.com/NITEMAN/varnish-bites/blob/master/varnish4/drupal-base.vcl
# - https://gitlab.wklive.net/snippets/32
...
/* Module (VMOD) imports */
# Standard module
# See https://varnish-cache.org/docs/4.1/reference/vmod_std.generated.html
import std;

# Directors module
# See https://varnish-cache.org/docs/4.1/reference/vmod_directors.generated.html
...
# See https://varnish-cache.org/docs/4.1/reference/vcl.html#probes
#probe basic {
...
# See https://varnish-cache.org/docs/4.1/reference/vcl.html#access-control-list-acl
acl purge_ban {
...
/* Custom subroutines */
# See https://varnish-cache.org/docs/4.1/reference/vcl.html#subroutines
...
# See https://www.varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-init
# Here is where you should declare your directors now.
# See https://varnish-cache.org/docs/4.1/reference/vmod_directors.generated.html
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-backends.html#directors
# Empty in simple configs
# sub vcl_init {
#     return (ok);
# }
...
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-fini
# sub vcl_fini {
#     return (ok);
# }
...
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-recv
sub vcl_recv {
  ...
  #}
  # Purge logic
  # See https://varnish-cache.org/docs/4.1/users-guide/purging.html#http-purging
  ...
  # Ban logic
  # See https://www.varnish-cache.org/docs/4.1/users-guide/purging.html#bans
  if ( req.method == "BAN" ) {
    if ( client.ip !~ purge_ban ) {
      return (synth(405, "Not allowed."));
    }
  ...
  # See https://varnish-cache.org/docs/4.1/whats-new/upgrade-4.0.html#x-forwarded-for-is-now-set-before-vcl-recv
  ...
  # Websocket support
  # See https://varnish-cache.org/docs/4.1/users-guide/vcl-example-websockets.html
  ...
  # See https://info.varnish-software.com/blog/grace-varnish-4-stale-while-revalidate-semantics-varnish
  ...
  # See https://varnish-cache.org/docs/4.1/phk/gzip.html#what-does-http-gzip-support-do
  # See https://varnish-cache.org/docs/4.1/users-guide/compression.html
  # See https://varnish-cache.org/docs/4.1/reference/varnishd.html?highlight=http_gzip_support
  ...
  # Empty in simple configs.
  # See https://varnish-cache.org/docs/4.1/users-guide/esi.html
...
# the connection.
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-pipe
sub vcl_pipe {
  # Websocket support
  # See https://varnish-cache.org/docs/4.1/users-guide/vcl-example-websockets.html
  if ( req.http.upgrade ) {
...
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-pass
# sub vcl_pass {
#     return (fetch);
# }
...
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-hash
sub vcl_hash {
  /* Hash cookie data */
...
# been evited.
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-purge
# sub vcl_purge {
...
# the cache.
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-hit
sub vcl_hit {
  if ( obj.ttl >= 0s ) {
  ...
  # See https://varnish-cache.org/docs/4.1/users-guide/vcl-grace.html
...
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-miss
# sub vcl_miss {
#     return (fetch);
# }

# vcl_deliver: Called before an object is delivered to the client
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-deliver
sub vcl_deliver {
  /* Ban lurker friendly bans support */
  # See https://varnish-cache.org/docs/4.1/users-guide/purging.html#bans
...
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-synth
/*
...
sub vcl_synth {
  ...
  # See https://varnish-cache.org/docs/4.1/reference/vmod_std.generated.html#func-fileread
...
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-backend-fetch
...
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-backend-response
sub vcl_backend_response {
  ...
  # See https://varnish-cache.org/docs/4.1/users-guide/compression.html
  # See https://varnish-cache.org/docs/4.1/phk/gzip.html
...
# See https://varnish-cache.org/docs/4.1/users-guide/vcl-built-in-subs.html#vcl-backend-error
